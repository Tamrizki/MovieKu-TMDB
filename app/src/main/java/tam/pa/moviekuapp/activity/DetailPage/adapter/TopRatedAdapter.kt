...
class TopRatedAdapter (val ctx: Context, val list: List<MovieListItem>?)
    ...
    class viewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(get: MovieListItem) {
            ...
            Picasso.get().load(apiCLient.BASE_URL_IMAGE+get.poster_path).fit().into(ivImage)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        return viewHolder(LayoutInflater.from(parent.context).inflate(R.layout.custom_list_small, parent, false))
    }
